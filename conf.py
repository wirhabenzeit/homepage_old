    ...
    def get_inproceedings_template(self, e):
        template = toplevel [
            ...
            words [
                'In',
                sentence [
                    self.format_btitle(e, 'booktitle', as_sentence=True),
                    self.format_volume_and_series(e, as_sentence=True),
                    optional[ pages ],
                ],
...
mathjax3_config = {
  ...
  "tex": {
    ...
    "mathtools": {
        "pairedDelimiters": {
            "set": ["\{","\}","\\renewcommand\given{\,\delimsize|\,\mathopen{}} #1",1,"",""]
        }
    }
  }
}
...
#tikz_tikzlibraries = "graphdrawing"

tikz_latex_preamble = '\\usegdlibrary{trees}'